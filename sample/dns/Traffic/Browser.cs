...
namespace CosineKitty.ZeroConfigWatcher
{
    public class Browser : IDisposable
    {
        ...
        private readonly Dictionary<string, ServiceCollection> serviceRoot = new Dictionary<string, ServiceCollection> ();
        private readonly Dictionary<string, HostInfo> hostTable = new Dictionary<string, HostInfo> ();
    ...
    {
        public readonly Dictionary<string, ServiceInfo> ServiceTable = new Dictionary<string, ServiceInfo>();
    ...
    {
        public readonly List<ServiceFact<RecordA>> addressList = new List<ServiceFact<RecordA>>();
