namespace Wisej.ChatServer
{
	partial class SimpleChatClient
	{
		...
		private Wisej.Web.Button buttonJoin;
		private Wisej.Web.Button buttonLeave;
		private Wisej.Web.ListBox listBoxMessage;
		private Wisej.Web.TextBox textBoxMessage;
		private Wisej.Web.Button buttonSend;
		private Wisej.Web.ErrorProvider errorProvider;
		private Wisej.Web.Label label1;
		private Wisej.Web.Timer updateTimer;
