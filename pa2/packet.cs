...
namespace pa
{
    ...
    class Label 
	{
        ...
        public byte Length {get { return (byte)label.Length; }}

        public Label( string s ) {// check for '.'
            label = s;
        }
    ...
    class PacketParser 
	{
		...
		public string		GetPointer( int length ) {
